...
SECRET_KEY = '4h9es1$3l_8nqjyx=y_($7k!w+fb%8t_+*vy5lfx=k0=-xwl=q'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'chat.context_processors.user_social_connection',
            ],
        },
    },
]
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("redis://:" + "MmaTxolXK9AWP020FczhPJu61qltFthR" + "@" + REDIS_HOST + ":" + str(REDIS_PORT) + "/0")],
        },
